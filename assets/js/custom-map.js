...
function createHomepageGoogleMap(_latitude,_longitude){
    ...
    if( document.getElementById('map') != null ){
        $.getScript("http://crm.3plblaster.com/assets/js/locations.js", function(){
            ...
            for (i = 0; i < locations.length; i++) {
                ...
                var marker = new MarkerWithLabel({
                    ...
                    map: map,
                    icon: 'http://crm.3plblaster.com/assets/img/marker.png',
            ...
            var clusterStyles = [
                {
                    url: 'http://crm.3plblaster.com/assets/img/cluster.png',
                    height: 37,
                    width: 37
                }
            ];
...
function createHomepageOSM(_latitude,_longitude,_zoom){	
    setMapHeight();
    if( document.getElementById('map') != null ){
